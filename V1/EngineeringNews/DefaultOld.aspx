<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DefaultOld.aspx.cs" Inherits="Engineering_News_Default" %>
...
<table width="100%" cellspacing="1" cellpadding="4" border="0">
	<tbody><tr class="head">
		<td align="center"><span style="font-size:30px;">Engineering News (Sep-Oct 2014) <a href="2014_07-08.aspx" target="_blank">Jul-Aug 2014</a></span>
        </td>
	</tr>
...
<table width="100%">
    ...
    <tr>
        <td align="center">
            <asp:Image ID="imgPage" runat="server" Width="690px"/>
        </td>
    </tr>
    <tr>
        <td align="center">
