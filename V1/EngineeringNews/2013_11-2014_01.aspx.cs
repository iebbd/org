...
public partial class Engineering_News_Default : System.Web.UI.Page
{
    ...
    {
        if (hfPageNo.Value == "52")
        {
            imgPage.ImageUrl = "files/2014_11-2014_01/EngineeringNews_2013_11-2014_01_small/52.jpg";
        }
        else
        {
            imgPage.ImageUrl = "files/2014_11-2014_01/EngineeringNews_2013_11-2014_01_small/" + decimal.Parse((int.Parse(hfPageNo.Value) % 52).ToString()).ToString("00") + ".jpg";
        }
