...
public partial class Engineering_News_Default : System.Web.UI.Page
{
    ...
    {
        if (hfPageNo.Value == "61")
        {
            imgPage.ImageUrl = "files/2014_04-05/61.jpg";
        }
        else
        {
            imgPage.ImageUrl = "files/2014_04-05/" + decimal.Parse((int.Parse(hfPageNo.Value) % 61).ToString()).ToString("00") + ".jpg";
        }
