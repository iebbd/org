...
public partial class Engineering_News_Default : System.Web.UI.Page
{
    ...
    {
        if (hfPageNo.Value == "83")
        {
            imgPage.ImageUrl = "files/2013_07-08/EngineeringNews_2013_07-08_small/83.jpg";
        }
        else
        {
            imgPage.ImageUrl = "files/2013_07-08/EngineeringNews_2013_07-08_small/" + decimal.Parse((int.Parse(hfPageNo.Value) % 83).ToString()).ToString("00") + ".jpg";
        }
