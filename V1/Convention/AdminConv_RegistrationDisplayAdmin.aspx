<%@ Page Language="C#" MasterPageFile="~/Login/AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminConv_RegistrationDisplayAdmin.aspx.cs" Inherits="AdminConv_RegistrationDisplay" Title="Display Conv_Registration By Admin" %>
    ...
    <div>
        ...
        <asp:GridView ID="gvConv_Registration" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                ...
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <a href='<%#Eval("ExtraField3") %>' target="_blank">Con</a>
                    </ItemTemplate>
                </asp:TemplateField>
