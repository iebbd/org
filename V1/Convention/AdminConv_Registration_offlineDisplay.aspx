<%@ Page Language="C#" MasterPageFile="~/Login/AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminConv_Registration_offlineDisplay.aspx.cs" Inherits="AdminConv_RegistrationDisplay" Title="Display Conv_Registration By Admin" %>
        ...
        <asp:GridView ID="gvConv_Registration" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%#Eval("Conv_RegistrationID") %>' OnClick="lbDelete_Click"  OnClientClick="return confirm('Delete?')" >
                            Delete
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
